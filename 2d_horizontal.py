...
thruster_dir = "20250413_data/thrust_data.csv"
...
linear_vel = pose_data[:, 6:9]
angular_vel = pose_data[:, 9:12]
timestamps = pose_data[:, 0]
thruster = thruster_data[:-1, 0:6]
...
hydro_coff_true = np.array([-5.5, -12.7, -14.57, -4.03, -18.18, -6.22, -21.66, -0.07, -1.55])

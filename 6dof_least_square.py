...
pose_dir = "3d_data/pose_data.csv"
thruster_dir = "3d_data/thrust_data.csv"
...
tau = motor.tau
u,v,w = bluerov.vel_b[:,0],bluerov.vel_b[:,1],bluerov.vel_b[:,2]
p,q,r = bluerov.vel_b[:,3],bluerov.vel_b[:,4],bluerov.vel_b[:,5]
